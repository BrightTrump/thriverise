...
export default function NavyBlueWhiteFilledRounded({
  children,
  className,
  disabled,
  isLoading,
  ...
  return (
    <button
      ...
      className={`grid grid-flow-col gap-2 items-center justify-center 
        font-bold md:text-lg rounded-4xl border border-[#183668] bg-[#183668] text-white px-5 py-3 transition-all duration-200
        ${
          disabled
