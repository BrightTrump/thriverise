...
export default function CampusSection3() {
  return (
    <section className="py-10 sm:py-20 layout-spacing bg-[#183668]">
      ...
      >
        <div className="grid gap-2.5 text-[#FFF8EB] [&>h1]:uppercase [&>h1]:font-bold [&>h1]:text-2xl [&>h1]:md:text-4xl">
          <h1>What the Program</h1>
          <h1>Entails</h1>
          <p className="">As a ThriveRise Campus Ambassador, you will:</p>
          ...
          <ul className="space-y-3">
            {[
              ...
              >
                <span className="w-2 h-2 rounded-full bg-[#027EBE] justify-self-center"></span>
                <span>{text}</span>
              </li>
            ))}
          </ul>
